defmodule MicroblogWeb.Coherence.SessionController do
  @moduledoc """
  Handle the authentication actions.

  """
  use MicroblogWeb.Coherence, :controller
  use Timex
  ...
  * Lockable is enabled and the user is not locked.
  ...
  def create(conn, params) do
    ...
    user = nil #Config.repo.one(from u in user_schema, where: field(u, ^login_field) == ^login)
